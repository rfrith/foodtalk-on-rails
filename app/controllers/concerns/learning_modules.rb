module LearningModules
  ...
  BETTER_U = [
      {id: 'BETTER_U[:keeping_track]', survey_id: 'SV_2m192rZTqtLT63H', img_path: 'keeping-track-cap.jpg', target_url: '/learn_online/better_u/keeping-track/story.html', title: "Keeping Track", description: "One of the best ways to manage your weight and nutrition health is to watch the portion size of your foods. Learn how to correctly measure different foods and some helpful tips to Keeping Track of how much you’re eating and drinking." },
      {id: 'BETTER_U[:no_thanks_im_sweet_enough]', survey_id: 'SV_0CIDt2IgyAkApxj', img_path: 'no-thanks-im-sweet-enough-cap.jpg', target_url: '/learn_online/better_u/no-thanks-im-sweet-enough/story.html', title: "No Thanks I'm Sweet Enough", description: "Did you know decreasing the amount of sugar you eat and drink could help prevent unwanted weight gain? Check out this short lesson to learn how you can decrease the sugar in your whole family’s meals and snacks." },
      {id: 'BETTER_U[:small_changes_equal_big_results]', survey_id: 'SV_5BAEJFx3222PkVL', img_path: 'small-changes-equal-big-results-cap.jpg', target_url: '/learn_online/better_u/small-changes-equal-big-results/story.html', title: 'Small Changes = Big Results', description: "Changing your entire diet sounds overwhelming right? Never fear -- following some of the tips in this lesson, you can make small shifts in what your family is already eating and see big results in their health and nutrition." },
      {id: 'BETTER_U[:what_gets_in_the_weigh]', survey_id: 'SV_4158YZmgkwvDgYB', img_path: 'handwriting-in-journal.jpg', target_url: 'https://ugeorgia.qualtrics.com/jfe/form/SV_4158YZmgkwvDgYB/?email=&uid=&redirect=/learn_online', title: 'What Gets in the Weigh', description: "A little planning goes a long way towards keeping yourself healthy and meeting your weight goals. Plans can go right out the window when unexpected challenges arise.  The ideas in this lesson can help make your healthy Better U plans & goals easier to reach." }
  ]

module Maps
  ...
  GA_SNAP_ED_MAPS = [
      {id: 'snap-ed-eligibility-locator', thumbnail: '/images/snap-ed-eligibility-locator.png', target_url: 'https://w-cookie.github.io/SNAP-Ed-Locator-Web-Tool/index.html', title: "Georgia SNAP-Ed Eligibility Locator", description: "" },
      {id: 'snap-ed-qualified-areas', thumbnail: '/images/snap-ed-implimentation-sites.png', target_url: 'https://w-cookie.github.io/SNAP-Ed-Site-Lists/index.html#7/32.706/-83.197', title: "Georgia SNAP-Ed Implementation Sites", description: "" },

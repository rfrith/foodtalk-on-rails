  ...
  def index
    begin
      ...
      if(playlist)
        ...
        playlist_items_url = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet%2CcontentDetails&playlistId=#{playlist}&maxResults=50&key=#{Rails.application.secrets.youtube_api_key}"
      else
        @playlist_id = Rails.application.secrets.youtube_default_channel
        playlist_items_url = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet%2CcontentDetails&playlistId=#{@playlist_id}&maxResults=50&key=#{Rails.application.secrets.youtube_api_key}"
      end

module LearningModules
  ...
  BETTER_U = [
      ...
      {id: 'BETTER_U[:small_changes_equal_big_results]', survey_id: 'SV_5BAEJFx3222PkVL', img_path: 'small-changes-equal-big-results-cap.jpg', target_url: '/foodtalk_lessons/small-changes-equal-big-results/story.html', title: 'Small Changes = Big Results', description: "Changing your entire diet sounds overwhelming right? Never fear -- following some of the tips in this lesson, you can make small shifts in what your family is already eating and see big results in their health and nutrition." },
  ...
  FOOD_ETALK = [
      ...
      {id: 'FOOD_ETALK[:keep_your_pressure_in_check]', survey_id: 'SV_4J9EgfTMf4CxAqx', img_path: 'ekg-heart.png', target_url: '/foodtalk_lessons/lesson2/story.html', title: 'Keep Your Pressure In Check', description: 'We’ve all heard it - too much salt or sodium is not good for us. But how the heck do we reduce it and still have tasty food? Check out this lesson for ideas on how to decrease your sodium and increase your family’s health.' },
      {id: 'FOOD_ETALK[:color_me_healthy]', survey_id: 'SV_7OQOsyGKadacIYZ', img_path: 'fruits-and-veggies-art.png', target_url: '/foodtalk_lessons/lesson3/story.html', title: 'Color Me Healthy', description: '“Yeah, yeah, yeah. My family is supposed to eat more fruits and veggies - but it’s not as easy as it sounds”. We get it, eating fruits and veggies can be challenging - which is why we’ve dedicated this lesson to helping you! Check it out and see for yourself.' },

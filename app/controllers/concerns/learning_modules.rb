module LearningModules
  ...
  BETTER_U = [
      {id: 'better_u/keeping_track', survey_id: 'SV_cAzmH6shyFTBYYR', img_path: 'keeping-track-cap.jpg', target_url: '/better_u/keeping-track/story_html5.html', title: "learning_modules.better_u.keeping_track.title", description: "learning_modules.better_u.keeping_track.description" },
      {id: 'better_u/no_thanks_im_sweet_enough', survey_id: 'SV_4ZyDGIOTVSB5YMt', img_path: 'no-thanks-im-sweet-enough-cap.jpg', target_url: '/better_u/no-thanks-im-sweet-enough/story_html5.html', title: "learning_modules.better_u.no_thanks_im_sweet_enough.title", description: "learning_modules.better_u.no_thanks_im_sweet_enough.description" },
      {id: 'better_u/small_changes_equal_big_results', survey_id: 'SV_1S1tw8h2jbCY0Nn', img_path: 'small-changes-equal-big-results-cap.jpg', target_url: '/better_u/small-changes-equal-big-results/story_html5.html', title: "learning_modules.better_u.small_changes_equal_big_results.title", description: "learning_modules.better_u.small_changes_equal_big_results.description" },
      {id: 'better_u/what_gets_in_the_weigh', survey_lesson: true, survey_id: 'SV_03dPmJ1w78nzy0R', img_path: 'handwriting-in-journal.jpg', target_url: '/surveys/what-gets-in-the-weigh', title: "learning_modules.better_u.what_gets_in_the_weigh.title", description: "learning_modules.better_u.what_gets_in_the_weigh.description" }
  ]

  FOOD_ETALK = [
      {id: 'food_etalk/your_food_your_choice', survey_id: 'SV_5orGxXVLOuOOi7b', img_path: 'shopping-woman.jpg', target_url: '/food_etalk/your-food-your-choice/story_html5.html', title: "learning_modules.food_etalk.your_food_your_choice.title", description: "learning_modules.food_etalk.your_food_your_choice.description" },
      {id: 'food_etalk/keep_your_pressure_in_check', survey_id: 'SV_5pe62A4BGi1yQOF', img_path: 'ekg-heart.png', target_url: '/food_etalk/keep-your-pressure-in-check/story_html5.html', title: "learning_modules.food_etalk.keep_your_pressure_in_check.title", description: "learning_modules.food_etalk.keep_your_pressure_in_check.description" },
      {id: 'food_etalk/color_me_healthy', survey_id: 'SV_1AFhHKkRyp6W6q1', img_path: 'fruits-and-veggies-art.png', target_url: '/food_etalk/color-me-healthy/story_html5.html', title: "learning_modules.food_etalk.color_me_healthy.title", description: "learning_modules.food_etalk.color_me_healthy.description"},
      {id: 'food_etalk/eat_well_on_the_go', survey_id: 'SV_4ZXiobIOIATC6VL', img_path: 'apple-in-hand.jpg', target_url: '/food_etalk/eat-well-on-the-go/story_html5.html', title: "learning_modules.food_etalk.eat_well_on_the_go.title", description: "learning_modules.food_etalk.eat_well_on_the_go.description" },
      {id: 'food_etalk/keep_yourself_well', survey_id: 'SV_bydzha2EVeuBhXf', img_path: 'moldy-food-sick-woman.jpg', target_url: '/food_etalk/keep-yourself-well/story_html5.html', title: "learning_modules.food_etalk.keep_yourself_well.title", description: "learning_modules.food_etalk.keep_yourself_well.description" },
      {id: 'food_etalk/play_food_etalk', survey_id: 'SV_39KvhtZUBgHa2tD', img_path: 'play-food-etalk.png', target_url: '/food_etalk/play-food-etalk/story_html5.html', title: "learning_modules.food_etalk.play_food_etalk.title", description: "learning_modules.food_etalk.play_food_etalk.description" }
  ]

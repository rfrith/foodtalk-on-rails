class ErrorsController < ApplicationController
  ...
  def bad_request
    respond_to do |format|
      @error = Rails.cache.fetch("HTTP400", expires_in: 1.year) do
        #TODO: I18N ME!!!
  ...
  def not_found
    @error = Rails.cache.fetch("HTTP404", expires_in: 1.year) do
      #TODO: I18N ME!!!
  ...
  def unacceptable
    @error = Rails.cache.fetch("HTTP422", expires_in: 1.year) do
      #TODO: I18N ME!!!
  ...
  def internal_error
    @error = Rails.cache.fetch("HTTP500", expires_in: 1.year) do
      #TODO: I18N ME!!!
